...
%LAFF_COPY - 
% copies column vectors to column vectors
% copies row vectors to column vectors
% copies column vectors to row vectors
% copies row vectors to row vectors
% Details -
% y = copy( x, y ) copies vector x into vector y
%   Vectors x and y can be a miture of column and/or row vectors.
